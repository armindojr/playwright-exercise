...
export class CalendarPage extends Base {
    ...
    constructor(page: Page) {
        ...
        this.btnYearRange = this.modalRange.locator('div.datepicker-nav > div > div.datepicker-nav-year');
        this.btnConfirmYear = this.modalRange.locator('div[data-year="2023"]');
        this.btnMonthRange = this.modalRange.locator('div.datepicker-nav > div > div.datepicker-nav-month');
